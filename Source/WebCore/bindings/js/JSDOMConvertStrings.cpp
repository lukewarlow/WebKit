...
String getTrustedTypeCompliantString(TrustedType expectedType, JSGlobalObject& global, JSValue input, const String& sink, ShouldConvertNullToEmptyString shouldConvertNullToEmptyString)
{
    VM& vm = global.vm();
    ...
    auto stringValueHolder = getTrustedTypeCompliantString(expectedType, *scriptExecutionContext, stringValue, sink);
